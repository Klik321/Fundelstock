...
const ContentSecurityPolicy = `
  ...
  connect-src 'self' https://finnhub.io https://newsapi.org https://www.alphavantage.co https://gnews.io https://api.stlouisfed.org wss://www.tradingview.com wss://data.tradingview.com https://symbol-search.tradingview.com https://data.tradingview.com https://widgetdata.tradingview.com https://*.tradingview.com;
  media-src 'self';
  object-src 'none';
  base-uri 'self';
  form-action 'self';
